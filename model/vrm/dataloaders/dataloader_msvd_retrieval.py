...
class MSVD_DataLoader(Dataset):
    ...
    def __init__(
        ...
        caption_file = os.path.join(self.data_path, "raw-captions2.pkl")
        ...
        for video_id in video_ids:
            ...
            for cap in captions[video_id]:
                ...
                if len(cap) > 1:
                    nlw = cap[1]
                self.sentences_dict[len(self.sentences_dict)] = (video_id, cap_txt, nlw)
    ...
    def __getitem__(self, idx):
        video_id, caption, nlw = self.sentences_dict[idx]
        pairs_text, pairs_mask, pairs_segment, choice_video_ids = self._get_text(video_id, caption)
        video, video_mask = self._get_rawvideo(choice_video_ids)
        return pairs_text, pairs_mask, pairs_segment, video, video_mask, nlw
